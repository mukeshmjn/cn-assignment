...
@Component({
  selector: 'app-bootcamp-upcoming',
  templateUrl: './bootcamp-upcoming.component.html',
  styleUrls: ['./bootcamp-upcoming.component.scss']
})
export class BootcampUpcomingComponent implements OnInit {
...
debugger
    ...
    this.evnt.getEventsList('BOOTCAMP_EVENT','Upcoming',this.tags).subscribe(res=>{
...
console.log(this.eventsPayload.indexOf(this.eventTagsData[i]));
  ...
  getEventList1(){
    debugger
        ...
        this.evnt.getEventsList1('BOOTCAMP_EVENT','Upcoming',this.tags,this.offset).subscribe(res=>{
