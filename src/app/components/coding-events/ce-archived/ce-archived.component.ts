...
@Component({
  selector: 'app-ce-archived',
  templateUrl: './ce-archived.component.html',
  styleUrls: ['./ce-archived.component.scss']
})
export class CeArchivedComponent implements OnInit {
  ...
  getEventList(){
    ...
    this.evnt.getEventsList('CODING_EVENT','Archived',this.tags).subscribe(res=>{
...
console.log(this.eventsPayload.indexOf(this.eventTagsData[i]));
  ...
  getEventList1(){
        ...
        this.evnt.getEventsList1('CODING_EVENT','Archived',this.tags,this.offset).subscribe(res=>{
